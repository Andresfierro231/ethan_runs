...
Generated: `2026-07-13T21:13:18+00:00`
...
- `F0_current_fluid_sources`: mean abs Tmean error `34.374 K`, mean mdot error vs CFD `0.008082 kg/s`, mean ambient loss `185.151 W`, max abs pressure residual `1.592 Pa`.
- `F1_heater_only`: mean abs Tmean error `4.609 K`, mean mdot error vs CFD `0.005477 kg/s`, mean ambient loss `148.151 W`, max abs pressure residual `2.017 Pa`.
