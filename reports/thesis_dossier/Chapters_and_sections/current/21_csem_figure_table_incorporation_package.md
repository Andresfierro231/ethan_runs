...
provenance:
  ...
  - work_products/2026-07/2026-07-21/2026-07-21_thesis_post_study_writing_refresh/README.md
...
| F-03B | `work_products/2026-07/2026-07-21/2026-07-21_velocity_magnitude_pictures/figures/composites/y_velocity_side_z_trimmed_composite_labeled.png` plus individual SVG/PDF panels in `figures/y_velocity_side_z/**` | Chapter 5 seeded exchange-CV path or Chapter 7 recirculation result | Four-case matched `side_z` y-velocity upcomer view for Salt1-Salt4, with signed `U_y` color and `abs(U_y)` glyph length on the shared range `[-0.07702504843473434, 0.07702504843473434] m/s`. | CL-14, CL-15, CL-27 | Ready diagnostic visual. Use to show up/down velocity structure under common scaling; do not infer an admitted recirculation fraction, exchange coefficient, or ordinary upcomer closure. |
| F-03C | `work_products/2026-07/2026-07-21/2026-07-21_velocity_magnitude_pictures/figures/composites/velocity_magnitude_side_z_trimmed_composite_labeled.png` plus individual SVG/PDF panels in `figures/velocity_magnitude_side_z/**` | Chapter 5 seeded exchange-CV path or Chapter 7 recirculation result | Four-case matched `side_z` resultant velocity upcomer view for Salt1-Salt4, with `|U|` color/glyph length on the shared range `[0.0, 0.07704159866519554] m/s`. | CL-14, CL-15, CL-27 | Ready diagnostic visual. Use for model-form validity and visual comparison only; no coefficient or final-score claim. |
...
| `figures/figures_rendered/paraview_velocity_y_arrows/val_salt_test_2_coarse_mesh_laminar/upcomer/svg/val_salt_test_2_coarse_mesh_laminar_upcomer_velocity_y_component_arrows_side_x.svg` | Chapter 6 split/admission caveat or Chapter 7 recirculation result | Salt2 validation/external upcomer y-component arrow view normal to `x`, showing only `U_y` direction/color rather than velocity magnitude. | Ready new SVG; PDF/PNG siblings exist. Diagnostic external/test visual only; `U_y` is qualitative component evidence, not closure training or admission evidence. |
| `figures/figures_rendered/paraview_velocity_y_arrows/val_salt_test_2_coarse_mesh_laminar/upcomer/svg/val_salt_test_2_coarse_mesh_laminar_upcomer_velocity_y_component_arrows_side_neg_x.svg` | Chapter 6 split/admission caveat or Chapter 7 recirculation result | Salt2 validation/external upcomer y-component opposite x-side view. | Ready new SVG; PDF/PNG siblings exist. Diagnostic external/test visual only. |
| `figures/figures_rendered/paraview_velocity_y_arrows/val_salt_test_2_coarse_mesh_laminar/upcomer/svg/val_salt_test_2_coarse_mesh_laminar_upcomer_velocity_y_component_arrows_side_y.svg` | Chapter 6 split/admission caveat or Chapter 7 recirculation result | Salt2 validation/external upcomer y-component view looking along `y`; y-directed glyphs appear mostly as circular ends because the arrows point into/out of the page. | Ready new SVG; PDF/PNG siblings exist. Diagnostic external/test visual only; use with a caption explaining the camera-axis caveat. |
| `figures/figures_rendered/paraview_velocity_y_arrows/val_salt_test_2_coarse_mesh_laminar/upcomer/svg/val_salt_test_2_coarse_mesh_laminar_upcomer_velocity_y_component_arrows_side_z.svg` | Chapter 6 split/admission caveat or Chapter 7 recirculation result | Salt2 validation/external upcomer y-component view normal to `z`, useful for showing up/down branchwise vertical velocity. | Ready new SVG; PDF/PNG siblings exist. Diagnostic external/test visual only; no closure or score claim. |
...
| `work_products/2026-07/2026-07-21/2026-07-21_negative_k_section_effective_thesis_case_dispatch/case_memo.md` | Chapter 6 and Chapter 7 pressure | Thesis-facing case for stopping current lower-right component-K attempts and preserving the signed residual as section-effective evidence. | Ready negative-result prose. Do not caption as negative physical dissipation or admitted component `K`. |
| `work_products/2026-07/2026-07-21/2026-07-21_hybrid_pressure_no_fit_performance_bakeoff/no_fit_performance_table.csv` | Chapter 7 pressure | No-fit performance table for observed decomposition, Salt2-frozen diagnostic transfer, oracle upper bound, and F3/Shah status. | Ready diagnostic table. Salt2-frozen max transfer error is sub-Pa, but candidate-reviewability remains blocked. |
| `work_products/2026-07/2026-07-21/2026-07-21_hybrid_pressure_no_fit_performance_bakeoff/residual_ownership_table.csv` | Chapter 6 pressure admission or Chapter 7 pressure result | Residual ownership table separating hydrostatic head, kinetic correction, missing straight/developing reference, and recirculating-section residual. | Ready as admission/ownership evidence; no component-K/F6 promotion. |
| `work_products/2026-07/2026-07-21/2026-07-21_velocity_magnitude_pictures/output_manifest.csv` | Chapter 5 or 7 figure assembly | Manifest for matched Salt1-Salt4 `side_z` upcomer velocity-y and velocity-magnitude panel outputs. | Ready. Prefer individual SVG/PDF panels for manuscript assembly; composites are review/layout aids. |
| `work_products/2026-07/2026-07-21/2026-07-21_velocity_magnitude_pictures/shared_velocity_ranges.csv` | Chapter 5 or 7 caption support | Shared velocity ranges for side-by-side Salt upcomer panels. | Ready. Ranges support visual comparability, not closure admission. |
| `work_products/2026-07/2026-07-21/2026-07-21_s13_upcomer_exchange_surface_input_manifest_from_seeded_cv/case_preflight_matrix.csv` | Chapter 5 and Chapter 6 | Seeded exchange-CV input-readiness table for Salt2/Salt3/Salt4. | Ready as input-manifest evidence only; sampler-ready rows remain `0/3`. |
| `work_products/2026-07/2026-07-21/2026-07-21_s13_seeded_heat_path_lane_release/heat_path_lane_table.csv` | Chapter 6 or 7 | S13 heat-path lane release/fail-close table. | Ready if path exists in package; must be captioned as fail-closed when `Q_wall_W` and same-window release rows remain zero. |
| `work_products/2026-07/2026-07-21/2026-07-21_thesis_study_s14_pressure_f6_nonrecirc_anchor_evidence/f6_branch_use_scorecard.csv` | Chapter 6 or 7 pressure | S14 branch-use scorecard: `53` rows, `0` admitted, diagnostic/future/do-not-use labels. | Ready diagnostic non-admission; no component K, F6 fit, clipped K, or hidden multiplier. |
| `work_products/2026-07/2026-07-21/2026-07-21_thesis_study_s14_pressure_f6_nonrecirc_anchor_evidence/f6_branch_decision_table.csv` | Chapter 7 pressure or limitations | Branch decision table naming `right_leg` and `test_section_span` as future ordinary lanes. | Ready future-work table; not current admission. |
| `work_products/2026-07/2026-07-21/2026-07-21_fluid_extbc_phase_h2_passive_heat_loss_attribution/tw5_response_waterfall.csv` | Chapter 7 thermal attribution | Phase E/H/H2 TW5 passive heat-loss response waterfall. | Ready train-only diagnostic; no passive-hA repair, freeze, or validation/holdout/external score. |
| `work_products/2026-07/2026-07-21/2026-07-21_fluid_extbc_phase_h2_passive_heat_loss_attribution/repair_candidate_predeclaration_gate.csv` | Chapter 8 future work | Passive-`hA` source-basis rebuild predeclaration gate. | Ready as future-candidate gate; `not_executed` and `not_admitted`. |
...
| `work_products/2026-07/2026-07-21/2026-07-21_thesis_post_study_writing_refresh/phase_progress_claim_table.csv` | Chapter 7 | Phase E/F/G/I/H external-BC progress table showing executable runtime path, residual ownership, admissibility boundaries, and heat-path responsiveness. | Negative diagnostic result only; no global passive-hA fit, repair, freeze, admission, or final score. |
| `work_products/2026-07/2026-07-21/2026-07-21_thesis_post_study_writing_refresh/chapter_ready_parallel_progress.md` | Chapter 7 or Chapter 8 | Copy-ready synthesis of the claim that the external-BC failure is diagnostic, not a dead end. | Localizes next uncertainty to external heat-path physical basis and missing source/sink or redistribution physics. |
...
## Writer-Facing Priority Queues

The current package-level handoff for the LaTeX writer is:
...
Use `thesis_artifact_priority_queue.csv` to decide what must enter the main
thesis text first. Use `analysis_explanation_gap_register.csv` to assign
prose-only versus compute-backed follow-up work. Use
`figure_table_polish_backlog.csv` to convert dense CSVs into main-text tables
or figures. These queues do not supersede the claim ledger and do not admit
new coefficients; they are routing and writing artifacts.
