...
This package compares per-case field-transport outputs across the current Salt-family rollout plus the four Water validation cases, publishing matched streamwise heat-loss and azimuthal wall-transport reductions.
...
- `val_water_test_1_coarse_mesh_laminar` from `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/tmp/2026-06-15_live_case_analysis/contract_fix_water_family/val_water_test_1_coarse_mesh_laminar`
- `val_water_test_2_coarse_mesh_laminar` from `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/tmp/2026-06-15_live_case_analysis/contract_fix_water_family/val_water_test_2_coarse_mesh_laminar`
- `val_water_test_3_coarse_mesh_laminar` from `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/tmp/2026-06-15_live_case_analysis/contract_fix_water_family/val_water_test_3_coarse_mesh_laminar`
- `val_water_test_4_coarse_mesh_laminar` from `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/tmp/2026-06-15_live_case_analysis/contract_fix_water_family/val_water_test_4_coarse_mesh_laminar`

## Method

- `streamwise_heat_loss_summary.csv` provides total signed and absolute loopwise heat-loss reductions.
- `parasitic_heat_loss_summary.csv` groups those reductions by the case-profile thermal role groups, currently `intended_transfer` and `parasitic_loss` across the included Salt and Water cases.
...
- `field_transport_package_index.csv`: `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/reports/2026-06-15_ethan_all_runs_field_transport_campaign/field_transport_package_index.csv`
- `field_transport_streamwise_heat_comparison.csv`: `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/reports/2026-06-15_ethan_all_runs_field_transport_campaign/field_transport_streamwise_heat_comparison.csv`
- `field_transport_grouped_heat_comparison.csv`: `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/reports/2026-06-15_ethan_all_runs_field_transport_campaign/field_transport_grouped_heat_comparison.csv`
- `field_transport_azimuthal_transport_comparison.csv`: `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/reports/2026-06-15_ethan_all_runs_field_transport_campaign/field_transport_azimuthal_transport_comparison.csv`
- `field_transport_branch_thermal_comparison.csv`: `/scratch/09748/andresfierro231/projects_scratch/ethan_runs/reports/2026-06-15_ethan_all_runs_field_transport_campaign/field_transport_branch_thermal_comparison.csv`
